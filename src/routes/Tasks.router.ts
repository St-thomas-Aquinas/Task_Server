...
import { taskUpdate } from "../controllers/Task.controller";
import { taskComplete } from "../controllers/Task.controller";
...
TaskRouter.delete("/complete/:TaskID", taskComplete);
TaskRouter.patch("/Update/:TaskID", taskUpdate);
